...
- Fluxos cobertos por 458 testes: 277 de backend (206 unitários, 5 de arquitetura e 66 contra SQL Server real), 138 de frontend e 43 E2E em Playwright desktop/mobile, lendo e-mails reais do Mailpit.
- Próximo passo: templates CSV de partidas e estatísticas; a revisão imutável e a apuração determinística entram com o motor de pontuação. Google OAuth foi adiado para uma etapa posterior antes da demonstração pública.
