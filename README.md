...
- Fluxos cobertos por 446 testes: 271 de backend (201 unitários, 5 de arquitetura e 65 contra SQL Server real), 132 de frontend e 43 E2E em Playwright desktop/mobile, lendo e-mails reais do Mailpit.
- Próximo passo: súmula e eventos objetivos, que fecham o registro do que aconteceu em campo e destravam a apuração. Google OAuth foi adiado para uma etapa posterior antes da demonstração pública.
