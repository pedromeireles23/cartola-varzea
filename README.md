...
- Fluxos cobertos por testes: 337 de backend (246 unitários, 5 de arquitetura e 86 contra SQL Server real), 181 de frontend e 49 E2E em Playwright desktop/mobile, lendo e-mails reais do Mailpit. Um deles espera o mercado fechar pelo relógio real e vê a escalação congelar na tela do celular.
- Próximo passo: o motor de pontuação, substituição e valorização, que traz a apuração determinística, a revisão imutável e a correção de rodada. Google OAuth foi adiado para uma etapa posterior antes da demonstração pública.
