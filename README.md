...
- Fluxos cobertos por 454 testes: 276 de backend (205 unitários, 5 de arquitetura e 66 contra SQL Server real), 135 de frontend e 43 E2E em Playwright desktop/mobile, lendo e-mails reais do Mailpit.
- Próximo passo: revisão consolidada da rodada e apuração determinística a partir das súmulas. Google OAuth foi adiado para uma etapa posterior antes da demonstração pública.
