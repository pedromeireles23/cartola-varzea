...
- Fluxos cobertos por 397 testes: 232 de backend (165 unitários, 5 de arquitetura e 62 contra SQL Server real), 124 de frontend e 41 E2E em Playwright desktop/mobile, lendo e-mails reais do Mailpit.
- Próximo passo: rodadas, partidas e súmulas, que é o que falta para a demonstração ter jogo de verdade. Google OAuth foi adiado para uma etapa posterior antes da demonstração pública.
