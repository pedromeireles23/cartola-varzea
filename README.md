...
- Em andamento: organizações. A API já cobre solicitação e aprovação de organizador, equipe auxiliar por convite e isolamento entre organizações; das telas, já existem a solicitação de acesso, a fila de aprovação, as organizações da conta e a equipe auxiliar; o aceite do convite vem a seguir. Google OAuth foi adiado para uma etapa posterior antes da demonstração pública.
