...
- Fluxos cobertos por testes: 443 de backend (349 unitários, 5 de arquitetura e 89 contra SQL Server real), 189 de frontend e 50 E2E em Playwright desktop/mobile, lendo e-mails reais do Mailpit. Um deles faz a jornada inteira no celular: monta o elenco, espera o mercado fechar pelo relógio real, vê a escalação congelar, a organização lança a súmula e publica, e a pontuação aparece para quem jogou.
- Próximo passo: a correção de rodada — reabrir com motivo, recalcular em cadeia as rodadas seguintes e avisar quem foi afetado. Google OAuth foi adiado para uma etapa posterior antes da demonstração pública.
