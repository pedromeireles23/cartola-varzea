...
- Fluxos cobertos por 311 testes: 167 de backend (107 unitários, 5 de arquitetura e 55 contra SQL Server real), 109 de frontend e 35 E2E em Playwright desktop/mobile, lendo e-mails reais do Mailpit.
- Próximo passo: a face pública do campeonato — leitura sem campos administrativos e busca simples de campeonatos publicados. Google OAuth foi adiado para uma etapa posterior antes da demonstração pública.
