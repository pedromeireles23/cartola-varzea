...
- Fluxos cobertos por 350 testes: 196 de backend (133 unitários, 5 de arquitetura e 58 contra SQL Server real), 117 de frontend e 37 E2E em Playwright desktop/mobile, lendo e-mails reais do Mailpit.
- Próximo passo: rodadas, partidas e súmulas, que é o que falta para a demonstração ter jogo de verdade; importação CSV do catálogo segue em paralelo. Google OAuth foi adiado para uma etapa posterior antes da demonstração pública.
