...
public sealed class AuthorizationMatrixTests
{
    ...
    [
        ...
        "GET /api/v1/fantasy -> " + Authenticated,
        "GET /api/v1/fantasy/{slug}/ -> " + Authenticated,
        "GET /api/v1/fantasy/{slug}/market -> " + Authenticated,
        "GET /api/v1/fantasy/{slug}/leagues/ -> " + Authenticated,
        "GET /api/v1/fantasy/{slug}/leagues/{leagueId:guid} -> " + Authenticated,
        ...
        "GET /api/v1/public/competitions/{slug}/standings -> " + Anonymous,
        "GET /api/v1/public/competitions/{slug}/teams/{teamId:guid} -> " + Anonymous,
        "GET /api/v1/public/competitions/{slug}/athletes/{athleteId:guid} -> " + Anonymous,
        ...
        "POST /api/v1/competitions/{competitionId:guid}/rounds/{roundId:guid}/reopen -> competition-owner-write",
        ...
        "POST /api/v1/notifications/read -> authenticated-write",
        "POST /api/v1/fantasy/{slug}/leagues/ -> authenticated-write",
        "POST /api/v1/league-invites/{code}/accept -> authenticated-write",
        "PUT /api/v1/fantasy/{slug}/leagues/{leagueId:guid}/invite -> authenticated-write",
        "DELETE /api/v1/fantasy/{slug}/leagues/{leagueId:guid} -> authenticated-write",
        "DELETE /api/v1/fantasy/{slug}/leagues/{leagueId:guid}/members/{membershipId:guid}"
            + " -> authenticated-write",
